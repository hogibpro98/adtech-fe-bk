<template>
  <v-container grid-list-xl fluid class="no-padding no-margin">
    <header-select-time
      v-model="date"
      title="Chi tiết log tin nhắn SMS"
      class="sticky-header"
    />
    <v-layout row wrap>
      <v-flex lg12>
    ...
    <sms-log-dialog ref="dialog" title="Chi tiết thay đổi"></sms-log-dialog>
  </v-container>
</template>
<script lang="ts">
  ...
  props: {
    ...
    toolbar: {
      ...
      default: () => ({
        ...
        isFullScreen: false,
        isDownload: true,
        exportResource: "/log/sms-detail-log"
      })
    },
    headerExcludes: {
      type: Array,
