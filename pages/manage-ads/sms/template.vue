<template>
  <v-container grid-list-xl fluid class="no-padding no-margin">
          ...
          >
            ...
            <template slot="item.ads_count" slot-scope="{ item }"
              ><a
                ...
                :href="
                  `/manage-ads/list-ads-sms?resource_sms_user_template_id=${item.id}`
                "
    ...
    />
    <sms-template-delete-dialog
      ref="deleteDialog"
      @action-success="refreshTable"
    />
    <sms-template-review-dialog ref="reviewDialog" @success="refreshTable" />
    <sms-template-mass-approve-dialog
      ref="massApproveDialog"
      @action-success="refreshTable(false, true)"
    />
    <sms-template-mass-reject-dialog
    ...
    <base-mass-delete-dialog
      ...
      @action-success="refreshTable(false, false)"
    />
    <api-instruction-template-sms-dialog ref="apiDialog" service="sms" />
  </v-container>
</template>
<script lang="ts">
...
import SmsTemplateDeleteDialog from "~/components/page/manage-ads/sms/template/SmsTemplateDeleteDialog.vue";
import SmsTemplateFormDialog from "~/components/page/manage-ads/sms/template/SmsTemplateFormDialog.vue";
import SmsTemplateReviewDialog from "~/components/page/manage-ads/sms/template/SmsTemplateReviewFormDialog.vue";
import massDeleteTableWrapper from "~/mixins/massDeleteTableWrapper";
import SmsTemplateMassApproveDialog from "~/components/page/manage-ads/sms/template/SmsTemplateMassApproveDialog.vue";
import SmsTemplateMassRejectDialog from "~/components/page/manage-ads/sms/template/SmsTemplateMassRejectDialog.vue";
import SmsTemplateMassDeleteDialog from "~/components/page/manage-ads/sms/template/SmsTemplateMassDeleteDialog.vue";
...
>).extend({
  components: {
    ...
    SmsTemplateMassDeleteDialog,
    SmsTemplateMassRejectDialog,
    SmsTemplateMassApproveDialog,
    SmsTemplateReviewDialog,
    SmsTemplateFormDialog,
    SmsTemplateDeleteDialog,
