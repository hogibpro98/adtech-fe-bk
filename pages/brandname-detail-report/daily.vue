  ...
  <v-container grid-list-xl fluid class="no-padding no-margin">
    <v-layout row wrap>
      <v-flex lg12>
        <v-card>
          ...
          >
            ...
            <template slot="item.type_customer" slot-scope="props">
            ...
            <template slot="header.month-ago">
              <v-row
                class="merge-header-cell no-padding no-margin align-items-center justify-content-center"
              >
                Lũy kế đến ngày {{ month | getDay }} tháng
            ...
            <template slot="item.date" slot-scope="props">
              ...
              >
                ...
                <v-col class="col-3 merge-child">
                  {{ props.item.revenue_brand_after_vat | currency }}
                </v-col>
              </v-row>
            </template>
            <template slot="item.month" slot-scope="props">
              ...
              >
                ...
                <v-col class="col-3 merge-child">
                  {{
                    props.item.actual_brand_money_consumption_month | currency
                  }}
                </v-col>
                <v-col class="col-3 merge-child">
            ...
            <template slot="item.different" slot-scope="props">
              ...
              >
                ...
                <v-col class="col-3 merge-child">
                  {{
                    props.item.actual_brand_money_consumption_different
                      | currency
                  }}
                </v-col>
                <v-col class="col-3 merge-child">
            ...
            <template slot="item.month-ago" slot-scope="props">
              <v-row
                class="no-margin no-padding justify-content-center align-items-center"
              >
                <v-col class="col-3 merge-child">
                ...
                <v-col class="col-3 merge-child">
                  {{
                    props.item.actual_brand_money_consumption_month_ago
                      | currency
                  }}
                </v-col>
                <v-col class="col-3 merge-child">
      ...
      <import-file-statistical
        ref="importFile"
        name="báo cáo ngày brandname"
        :resource="resource"
        sample-url="/import/template_import_tong_hop_bao_cao_brandname_theo_ngay.xlsx"
      />
...
import { REPORT_BRAND_BY_DAY, REPORT_TOTAL_DAY } from "~/constants/resource";
...
export default Vue.extend({
  ...
  props: {
    toolbar: {
      ...
      default: () => ({
        isDownload: true,
        exportResource: REPORT_BRAND_BY_DAY,
        isSearch: true,
        isSynthesis: true,
        isImport: true
      })
    ...
    pageName: {
      type: String,
      default: "brandname-detail-report-daily"
    }
  },
  data() {
    return {
  ...
  computed: {
    ...
    headers() {
      return [
        ...
        {
          text: "lũy thừa đến ngày n tháng N",
          sortable: false,
          value: "month",
          class: "no-padding",
          cellClass: "no-padding",
  ...
  methods: {
    ...
    async handRebootTime() {
      ...
      try {
        const result = await this.$axios.$post("report-brand-by-day/update", {
