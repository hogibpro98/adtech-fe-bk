...
import { SMS_DAY, SMS_VENDOR_DAY } from "~/constants/resource";
...
export default {
  ...
  methods: {
    ...
    async getSummary(params) {
      try {
        const { data } = await this.$SMSVendorDayRepository.post(
          "summary",
          params
        );
        this.summary = data;
