...
import DataChart from "~/components/page/revenue/inventory/data-chart/DataChart.vue";
import GlobalDataInterface from "~/interface/data/global";
import {
  ChartDataInterface,
  TableDataInterface
} from "~/components/common/ShowChartAndTable.vue";
import DataTable from "~/components/page/revenue/inventory/data-table/DataTable.vue";
