...
const TelcoTemplateFormDialog = (Vue as VueConstructor<
  Vue & ComponentData & ComponentMethods
>).extend({
  name: "TelcoTemplateFormDialog",
  components: {
    UserSelect,
...
export default TelcoTemplateFormDialog;
export type TelcoTemplateFormDialogRef = InstanceType<
  typeof TelcoTemplateFormDialog
>;
</script>
