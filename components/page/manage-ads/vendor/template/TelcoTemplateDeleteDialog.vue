...
const TelcoTemplateDeleteDialog = (Vue as VueConstructor<
  Vue & ComponentData & ComponentMethod
>).extend({
  name: "TelcoTemplateDeleteDialog",
...
export default TelcoTemplateDeleteDialog;
export type TelcoTemplateDeleteDialogRef = InstanceType<
  typeof TelcoTemplateDeleteDialog
>;
</script>
