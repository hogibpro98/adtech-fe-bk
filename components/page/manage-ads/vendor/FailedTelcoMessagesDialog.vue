...
interface ComponentData {
  $logSmsVendorDistributionRepository: RepositoryInterface;
  showing: boolean;
  item: any;
  loading: boolean;
...
const FailedSmsMessageDialog = (Vue as VueConstructor<
  Vue & ComponentData & ComponentMethods
  >).extend({
  name: "FailedSmsMessageDialog",
  ...
  methods: {
    async show(item) {
      ...
      this.loading = true;
      try {
        const res = await this.$logSmsVendorDistributionRepository.post("", {
          ads_id: item
        });
        this.item = res.data;
        this.data = this.item
...
export default FailedSmsMessageDialog;
export type FailedSmsMessageDialogRef = InstanceType<
  typeof FailedSmsMessageDialog
  >;
</script>
