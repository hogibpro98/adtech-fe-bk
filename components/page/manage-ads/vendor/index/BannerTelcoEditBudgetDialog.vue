<template>
  ...
  >
    <template slot="content">
      <step-add-budget-banner-sms v-model="item" class="min-h-11r" />
    </template>
  </form-dialog>
</template>
<script lang="ts">
...
const BannerTelcoEditBudgetDialog = (Vue as VueConstructor<
  Vue & ComponentData & ComponentMethod
>).extend({
  name: "BannerTelcoEditBudgetDialog",
  components: {
...
export default BannerTelcoEditBudgetDialog;
export type BannerTelcoEditBudgetDialogRef = InstanceType<
  typeof BannerTelcoEditBudgetDialog
>;
</script>
