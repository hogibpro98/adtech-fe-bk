...
const StepAddBudgetBannerSms = (Vue as VueConstructor<
  Vue & ComponentData & ComponentMethod
>).extend({
  name: "StepAddBudgetBannerSms",
...
export default StepAddBudgetBannerSms;
export type StepAddBudgetBannerSmsRef = InstanceType<
  typeof StepAddBudgetBannerSms
>;
</script>
