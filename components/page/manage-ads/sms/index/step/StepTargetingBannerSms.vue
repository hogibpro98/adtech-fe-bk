...
const StepTargetingBannerSms = (Vue as VueConstructor<
  Vue & ComponentData
>).extend({
  name: "StepTargetingBannerSms",
  components: {
...
export default StepTargetingBannerSms;
export type StepTargetingBannerSmsRef = InstanceType<
  typeof StepTargetingBannerSms
>;
</script>
