<template>
  <v-row class="step-preview-banner no-margin">
    ...
    <banner-edit-targeting-dialog
      ...
      @submit="onSaveData"
    />
    <banner-sms-edit-information-dialog
      ref="refEditBannerInformationDialog"
      :is-show="isShow"
      @submit="onSaveData"
    />
    <banner-sms-edit-budget-dialog
    ...
    <banner-edit-targeting-optional-dialog
      ...
      @submit="onSaveData"
    />
    <banner-sms-edit-type-targeting-dialog
...
import BannerSmsEditInformationDialog from "~/components/page/manage-ads/sms/index/step/BannerSmsEditInformationDialog.vue";
...
const StepReviewBannerSms = (Vue as VueConstructor<
  Vue & ComponentData & ComponentMethods
>).extend({
  name: "StepReviewBannerSms",
  components: {
    BannerSmsEditBudgetDialog,
    BannerSmsEditTypeTargetingDialog,
    PreviewContentBannerSms,
    BannerSmsEditInformationDialog,
    ConfirmDialog,
  ...
  computed: {
    ...
    isPermissionShowPrice() {
      return this.$can(`manage-ads-list-ads-sms.${ACTIONS.SHOW_PRICE}`);
    },
    readonly() {
      if (this.value?.id) {
...
export default StepReviewBannerSms;
export type StepReviewBannerSmsRef = InstanceType<typeof StepReviewBannerSms>;
</script>
