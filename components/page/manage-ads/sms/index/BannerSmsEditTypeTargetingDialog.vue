...
const BannerSmsEditTypeTargetingDialog = (Vue as VueConstructor<
  Vue & ComponentData & ComponentMethod
>).extend({
  name: "BannerSmsEditTypeTargetingDialog",
  components: {
...
export default BannerSmsEditTypeTargetingDialog;
export type BannerSmsEditTypeTargetingDialogRef = InstanceType<
  typeof BannerSmsEditTypeTargetingDialog
>;
</script>
