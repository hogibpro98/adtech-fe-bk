...
const SmsTemplateMassApproveDialog = (Vue as VueConstructor<
  Vue & ComponentData & ComponentMethod
>).extend({
  name: "SmsTemplateMassApproveDialog",
...
export default SmsTemplateMassApproveDialog;
export type CampaignDeleteDialogRef = InstanceType<
  typeof SmsTemplateMassApproveDialog
>;
</script>
