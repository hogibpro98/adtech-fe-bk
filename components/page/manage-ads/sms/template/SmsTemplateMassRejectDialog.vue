...
const SmsTemplateMassRejectDialog = (Vue as VueConstructor<
  Vue & ComponentData & ComponentMethod
>).extend({
  name: "SmsTemplateMassRejectDialog",
...
export default SmsTemplateMassRejectDialog;
export type CampaignDeleteDialogRef = InstanceType<
  typeof SmsTemplateMassRejectDialog
>;
</script>
