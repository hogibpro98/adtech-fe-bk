...
const SaveSmsTemplateDialog = (Vue as VueConstructor<
  Vue & ComponentData & ComponentMethod
>).extend({
  name: "SaveSmsTemplateDialog",
...
export default SaveSmsTemplateDialog;
export type SaveSmsTemplateDialogRef = InstanceType<
  typeof SaveSmsTemplateDialog
>;
</script>
