<template>
  <confirm-dialog
    ...
    :loading="loading"
    title="Bạn muốn duyệt quảng cáo?"
    label-button-confirm="Xác nhận"
    @confirm="confirmItem"
  >
    <template slot="content">
      Bạn có chắc chắn muốn duyệt quảng cáo
...
const BannerApproveDialog = (Vue as VueConstructor<
  Vue & ComponentData & ComponentMethod
>).extend({
  name: "BannerApproveDialog",
...
export default BannerApproveDialog;
export type BannerApproveDialogRef = InstanceType<typeof BannerApproveDialog>;
</script>
