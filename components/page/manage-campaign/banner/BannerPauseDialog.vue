<template>
  <confirm-dialog
    ...
    :loading="loading"
    title="Bạn muốn tạm dừng quảng cáo?"
    label-button-confirm="Xác nhận"
    @confirm="confirmItem"
  >
    <template slot="content">
      Bạn có chắc chắn muốn tạm dừng quảng cáo
...
import {CODE_SUCCESS, HTTP_CODE_422, HTTP_CODE_NO_PERMISSION} from "~/constants/code";
...
const BannerPauseDialog = (Vue as VueConstructor<
  Vue & ComponentData & ComponentMethod
>).extend({
  name: "BannerPauseDialog",
    ...
    async confirmItem() {
      ...
      try {
        ...
        if (res.code === CODE_SUCCESS) {
          ...
          this.$toast.global.action_success("tạm dừng quảng cáo");
        } else {
...
export default BannerPauseDialog;
export type BannerPauseDialogRef = InstanceType<typeof BannerPauseDialog>;
</script>
