\<template>
  <confirm-dialog
    ...
    :loading="loading"
    title="Duyệt nhiều quảng cáo tin nhắn SMS"
...
const BannerSmsApproveMultiDialog = (Vue as VueConstructor<
  Vue & ComponentData & ComponentMethod
>).extend({
  name: "BannerSmsApproveMultiDialog",
...
export default BannerSmsApproveMultiDialog;
export type CampaignDeleteDialogRef = InstanceType<
  typeof BannerSmsApproveMultiDialog
>;
</script>
