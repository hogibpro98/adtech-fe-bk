...
const BannerMMSTemplateFormReviewDialog = (Vue as VueConstructor<
  Vue & ComponentData & ComponentMethod
>).extend({
  name: "BannerMMSTemplateFormReviewDialog",
  components: {
  ...
  methods: {
    show(item = null) {
      ...
      this.title = "Duyệt quảng cáo tin nhắn MMS";
      clearTimeout(this.timeout);
    },
    renderFile(file) {
...
export default BannerMMSTemplateFormReviewDialog;
export type BannerMMSTemplateFormReviewDialogRef = InstanceType<
  typeof BannerMMSTemplateFormReviewDialog
>;
</script>
