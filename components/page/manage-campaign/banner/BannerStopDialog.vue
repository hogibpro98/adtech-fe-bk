<template>
  <confirm-dialog
    ...
    :loading="loading"
    title="Bạn muốn dừng quảng cáo?"
    label-button-confirm="Xác nhận"
    @confirm="confirmItem"
  >
    <template slot="content">
      Bạn có chắc chắn muốn dừng quảng cáo
...
const BannerStopDialog = (Vue as VueConstructor<
  Vue & ComponentData & ComponentMethod
>).extend({
  name: "BannerStopDialog",
    ...
    async confirmItem() {
      ...
      try {
        ...
        if (res.code === CODE_SUCCESS) {
          ...
          this.$toast.global.action_success("dừng quảng cáo");
        } else {
...
export default BannerStopDialog;
export type BannerStopDialogRef = InstanceType<typeof BannerStopDialog>;
</script>
