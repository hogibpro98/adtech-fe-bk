...
const BannerMMSFormReviewDialog = (Vue as VueConstructor<
  Vue & ComponentData & ComponentMethod
>).extend({
  name: "BannerMMSFormReviewDialog",
  components: {
    StepReviewBannerMMS,
    BannerApproveDialog,
    BannerRejectDialog,
...
export default BannerMMSFormReviewDialog;
export type BannerMMSFormReviewDialogRef = InstanceType<
  typeof BannerMMSFormReviewDialog
>;
</script>
