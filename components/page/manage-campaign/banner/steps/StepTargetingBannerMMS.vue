...
const StepTargetingBannerMMS = (Vue as VueConstructor<
  Vue & ComponentData
>).extend({
  name: "StepTargetingBannerMMS",
  components: {
...
export default StepTargetingBannerMMS;
export type StepTargetingBannerMMSRef = InstanceType<
  typeof StepTargetingBannerMMS
>;
</script>
