...
const StepImportFileTargetingBannerMMS = (Vue as VueConstructor<
  Vue & ComponentData
>).extend({
  name: "StepImportFileTargetingBannerMMS",
...
export default StepImportFileTargetingBannerMMS;
export type StepImportFileTargetingBannerMMSRef = InstanceType<
  typeof StepImportFileTargetingBannerMMS
>;
</script>
