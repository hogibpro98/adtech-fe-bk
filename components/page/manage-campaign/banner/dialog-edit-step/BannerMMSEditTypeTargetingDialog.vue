<template>
  ...
  >
    <template slot="content">
      ...
      <div
        v-if="
          item.targeting_type === 'phone_group' &&
            item.phone_group &&
            item.phone_group.numbers
        "
      >
...
const BannerMMSEditTypeTargetingDialog = (Vue as VueConstructor<
  Vue & ComponentData & ComponentMethod
>).extend({
  name: "BannerMMSEditTypeTargetingDialog",
  components: {
...
export default BannerMMSEditTypeTargetingDialog;
export type BannerMMSEditTypeTargetingDialogRef = InstanceType<
  typeof BannerMMSEditTypeTargetingDialog
>;
</script>
