...
const BannerDeleteDialog = (Vue as VueConstructor<
  Vue & ComponentData & ComponentMethod
>).extend({
  name: "BannerDeleteDialog",
    ...
    async deleteItem() {
      ...
      try {
        ...
        if (res.code === CODE_SUCCESS) {
          ...
          this.$toast.global.delete_success("quảng cáo");
        } else {
...
export type BannerDeleteDialogRef = InstanceType<typeof BannerDeleteDialog>;
</script>
