<template>
  <confirm-dialog
    ...
    :loading="loading"
    title="Bạn muốn tạm dừng chiến dịch?"
    label-button-confirm="Xác nhận"
    @confirm="confirmItem"
  >
    <template slot="content">
      Bạn có chắc chắn muốn tạm dừng chiến dịch
...
const CampaignPauseDialog = (Vue as VueConstructor<
  Vue & ComponentData & ComponentMethod
>).extend({
  name: "CampaignPauseDialog",
    ...
    async confirmItem() {
      ...
      try {
        ...
        if (res.code === CODE_SUCCESS) {
          ...
          this.$toast.global.action_success("tạm dừng chiến dịch");
        } else {
...
export type CampaignPauseDialogRef = InstanceType<typeof CampaignPauseDialog>;
</script>
