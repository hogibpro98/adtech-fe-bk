<template>
  <confirm-dialog
    ...
    :loading="loading"
    title="Bạn muốn chạy chiến dịch?"
    label-button-confirm="Xác nhận"
    @confirm="confirmItem"
  >
    <template slot="content">
      Bạn có chắc chắn muốn chạy chiến dịch
...
const CampaignStartDialog = (Vue as VueConstructor<
  Vue & ComponentData & ComponentMethod
>).extend({
  name: "CampaignStartDialog",
    ...
    async confirmItem() {
      ...
      try {
        ...
        if (res.code === CODE_SUCCESS) {
          ...
          this.$toast.global.action_success("chạy chiến dịch");
        } else {
...
export default CampaignStartDialog;
export type CampaignStartDialogRef = InstanceType<typeof CampaignStartDialog>;
</script>
