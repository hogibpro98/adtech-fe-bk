<template>
  <div class="layout-img-above" :style="styleComponent">
...
const LayoutImgAbove = (Vue as VueConstructor).extend({
  name: "LayoutImgAbove",
  props: {
    data: {
      type: Object,
...
export default LayoutImgAbove;
export type LayoutImgAboveRef = InstanceType<typeof LayoutImgAbove>;
</script>
