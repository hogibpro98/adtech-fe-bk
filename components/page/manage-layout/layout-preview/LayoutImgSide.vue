<template>
  <div class="layout-img-side" :style="styleComponent">
    <div :style="styleImage" class="layout-media">
      <v-img
...
const LayoutImgSide = (Vue as VueConstructor).extend({
  name: "LayoutImgSide",
  props: {
    data: {
      type: Object,
...
export default LayoutImgSide;
export type LayoutImgSideRef = InstanceType<typeof LayoutImgSide>;
</script>
