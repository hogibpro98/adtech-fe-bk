...
const ConfigVendorAccountDialog = Vue.extend<
  ComponentData,
  ComponentMethod,
  ComponentComputed,
  ComponentProp
>({
  name: "ConfigVendorAccountDialog",
...
export default ConfigVendorAccountDialog;
export type ConfigVendorAccountDialogRef = InstanceType<typeof ConfigVendorAccountDialog>;
</script>
