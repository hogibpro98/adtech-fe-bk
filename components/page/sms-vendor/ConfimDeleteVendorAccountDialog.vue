...
const ConfimDeleteVendorAccountDialog = Vue.extend({
  name: "ConfimDeleteVendorAccountDialog",
  data() {
    return {
      isShow: false,
      isLoading: false,
...
export default ConfimDeleteVendorAccountDialog;
export type ConfimDeleteVendorAccountDialogRef = InstanceType<
  typeof ConfimDeleteVendorAccountDialog
>;
</script>
