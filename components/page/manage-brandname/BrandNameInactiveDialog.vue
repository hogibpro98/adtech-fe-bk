<template>
  <confirm-dialog
    ...
    :loading="loading"
    title="Bạn muốn khóa brandname?"
    label-button-confirm="Xác nhận"
    @confirm="confirmItem"
  >
    <template slot="content">
      Bạn có chắc chắn muốn khóa brandname
...
const BrandNameInactiveDialog = (Vue as VueConstructor<
  Vue & ComponentData & ComponentMethods
>).extend({
  name: "BrandNameInactiveDialog",
    ...
    async confirmItem() {
      ...
      try {
        ...
        if (res.code === CODE_SUCCESS) {
          ...
          this.$toast.global.action_success("khóa");
        } else {
...
export default BrandNameInactiveDialog;
export type BrandNameInactiveDialogRef = InstanceType<
  typeof BrandNameInactiveDialog
>;
</script>
