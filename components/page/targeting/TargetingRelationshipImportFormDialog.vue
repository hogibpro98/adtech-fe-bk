<template>
  <form-dialog
    ...
    title="Tải lên dữ liệu các tình trạng hôn nhân"
...
const TargetingRelationshipImportFormDialog = (Vue as VueConstructor<
  Vue & ComponentData & ComponentMethods
>).extend({
  name: "TargetingRelationshipImportFormDialog",
  components: {
    FileUpload,
  ...
  props: {
    sampleUrl: {
      type: String,
      default: "/targeting/templates/Template_Import_tình_trạng_hôn_nhân.xlsx"
    }
  },
  data() {
    return {
  ...
  methods: {
    ...
    async onSubmit() {
      ...
      try {
        ...
        const res = await this.$relationshipRepository.post("import", data);
        this.loading = false;
...
export default TargetingRelationshipImportFormDialog;
export type TargetingRelationshipImportFormDialogRef = InstanceType<
  typeof TargetingRelationshipImportFormDialog
>;
</script>
