...
const TargetingLocationDeleteDialog = (Vue as VueConstructor<
  Vue & ComponentData & ComponentMethods
>).extend({
  name: "TargetingLocationDeleteDialog",
  ...
  methods: {
    ...
    async deleteItem() {
      this.loading = true;
      try {
        const res = await this.$targetingLocationRepository.delete({
          id: this.item.id
        });
        this.loading = false;
        if (res.code === CODE_SUCCESS) {
          ...
          this.$toast.global.delete_success("vị trí");
        } else {
...
export default TargetingLocationDeleteDialog;
export type TargetingLocationDeleteDialogRef = InstanceType<
  typeof TargetingLocationDeleteDialog
>;
</script>
