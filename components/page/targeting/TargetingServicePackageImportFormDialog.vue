<template>
  <form-dialog
    ...
    title="Tải lên dữ liệu các gói cước"
...
const TargetingServicePackageImportFormDialog = (Vue as VueConstructor<
  Vue & ComponentData & ComponentMethods
>).extend({
  name: "TargetingServicePackageImportFormDialog",
  components: {
    FileUpload,
  ...
  props: {
    sampleUrl: {
      type: String,
      default: "/targeting/templates/Template_Import_gói_cước.xlsx"
    }
  },
  data() {
    return {
  ...
  methods: {
    ...
    async onSubmit() {
      ...
      try {
        ...
        const res = await this.$servicePackageRepository.post("import", data);
        this.loading = false;
...
export default TargetingServicePackageImportFormDialog;
export type TargetingServicePackageImportFormDialogRef = InstanceType<
  typeof TargetingServicePackageImportFormDialog
>;
</script>
