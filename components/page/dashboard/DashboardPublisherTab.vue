<template>
  <div>
    <v-layout row wrap>
      ...
      <v-flex xs12 xl6>
        <simple-pie-chart
          title="Cơ cấu doanh thu theo thiết bị"
          :filter="currentFilter"
          :time-range="dateStatistics"
          url="/publisher/device-summary"
        />
      </v-flex>
    </v-layout>
  </div>
...
import PublisherOverview from "~/components/page/dashboard/publisher/PublisherOverview.vue";
import PublisherCompareOverview from "~/components/page/dashboard/publisher/PublisherCompareOverview.vue";
...
const DashboardPublisherTab = (Vue as VueConstructor<
  Vue & ComponentData & ComponentMethods
>).extend({
  components: {
    PublisherCompareOverview,
    PublisherOverview,
...
export default DashboardPublisherTab;
export type DashboardPublisherTabRef = InstanceType<
  typeof DashboardPublisherTab
>;
</script>
