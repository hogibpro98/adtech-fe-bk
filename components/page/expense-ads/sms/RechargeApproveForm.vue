...
const RechargeApproveDialog = (Vue as VueConstructor<
  Vue & ComponentData & ComponentMethods
>).extend({
  name: "RechargeApproveDialog",
  components: {
    FileUpload,
  ...
  methods: {
    ...
    async approveItem() {
      this.loading = true;
      try {
        const res = await this.$agencyWalletSmsTransactionRepository.approve({
          id: this.item.id,
          date: this.item.date,
...
export default RechargeApproveDialog;
export type RechargeApproveDialogRef = InstanceType<
  typeof RechargeApproveDialog
>;
</script>
