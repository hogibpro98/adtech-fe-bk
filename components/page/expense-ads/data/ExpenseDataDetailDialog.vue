  ...
  >
    ...
    <template>
      ...
      <v-flex xs12 class="form-group">
        <charge-data-expense-table
          v-if="item.type === 'charge'"
          ref="table"
          :filter-custom="filterTableCharge"
        />
        <recharge-expense-data-table
...
import RechargeExpenseDataTable from "~/components/page/expense-ads/data/RechargeExpenseDataTable.vue";
import ChargeDataExpenseTable from "~/components/page/expense-ads/data/ChargeDataExpenseTable.vue";
...
const ExpenseDataDetailDialog = (Vue as VueConstructor<
  Vue & ComponentData & ComponentMethods
>).extend({
  name: "ExpenseDataDetailDialog",
  components: {
    ChargeDataExpenseTable,
    RechargeExpenseDataTable,
...
export default ExpenseDataDetailDialog;
export type ExpenseDataDetailDialogRef = InstanceType<
  typeof ExpenseDataDetailDialog
>;
</script>
