...
>).extend({
  ...
  methods: {
    show(item = null) {
      ...
      this.title = `${this.isEdit ? "Cập nhật" : "Thêm"} cấu hình Brandname`;
    ...
    async addItem() {
      ...
      try {
        ...
        if (res.code === CODE_SUCCESS) {
          ...
          this.$toast.global.add_success("cấu hình Brandname");
        } else {
    ...
    async editItem() {
      ...
      try {
        ...
        if (res.code === CODE_SUCCESS) {
          ...
          this.$toast.global.edit_success("cấu hình Brandname");
        } else {
          this.$toast.global.action_fail();
        }
      } catch (e) {
