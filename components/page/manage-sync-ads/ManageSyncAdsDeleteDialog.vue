...
const ManageSyncAdsDeleteDialog = (Vue as VueConstructor<
  Vue & ComponentData & ComponentMethods
>).extend({
  name: "ManageSyncAdsDeleteDialog",
  ...
  methods: {
    ...
    async deleteItem() {
      this.loading = true;
      try {
        const res = await this.$axios.$post("sync-manual-summary-day/delete", {
          id: this.item.id
        });
        this.loading = false;
...
export default ManageSyncAdsDeleteDialog;
export type ManageSyncAdsDeleteDialogRef = InstanceType<
  typeof ManageSyncAdsDeleteDialog
>;
</script>
