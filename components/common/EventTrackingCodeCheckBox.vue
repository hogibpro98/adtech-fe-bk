<template>
  ...
  >
    ...
    <div>
      <code-block :script="computedConvertURL" />
      <v-checkbox
...
export default (Vue as VueConstructor).extend({
  name: "EventTrackingCodeCheckBox",
  components: {
    ErrorDisplay,
    CodeBlock
  },
  ...
  computed: {
    ...
    computedConvertURL() {
      return (
        ...
        this.innerValue.services.map(item => `${item}=${item}`).join("&")
      );
    }
  },
  watch: {
