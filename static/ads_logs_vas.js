document.getElementById("mgid-root").addEventListener("click", async event => {
  const zone = document
    .getElementById("mgid-root")
    .firstElementChild.getAttribute("id");
  const zoneId = zone.split("_")[0];
  ...
  if (index !== -1) {
    ...
    if (aTag.hasAttribute("data-hash")) {
      const data = [];
      const adsTag = aTag.parentElement.querySelector("[data-i]");
      const adsId = adsTag.getAttribute("data-i");
      const adsHash = aTag.getAttribute("data-hash");
      const hostname = window.location.hostname;
      const time = Date.now();
      const hashStr = adsId + ";banner_click;" + time;
      data[hashStr] = {
        ads_id: adsId,
        hash: adsHash,
        hostname,
      ...
      sendRequest("http://10.58.41.135:8988/logs/partner", payload);
    }
  }
});
...
function handleRootWatcher() {
  const zone = document
    ...
    .firstElementChild.getAttribute("id");
  const zoneId = zone.split("_")[0];
  rootElement = document.getElementById("mgid-root").firstElementChild
  ...
  const observer2 = new PerformanceObserver(entries => {
    entries.getEntriesByType("resource").forEach(function(res) {
      ...
      if (url.host == "c.mgid.com") {
        ...
        if (params.v) {
          const adHashes = params.v.split("|").filter(function(e) {
            return isNaN(e);
          });
          for (index in adHashes) {
            const adHash = adHashes[index];
            const aTag = rootElement.querySelector(
              'a[data-hash="' + adHash + '"]'
            );
            const data = [];
            const adsTag = aTag.parentElement.querySelector("[data-i]");
            ...
            const adsHash = aTag.getAttribute("data-hash");
            const hostname = window.location.hostname;
            const time = params.cbuster.slice(0, 13);
            const hashStr = adsId + ";banner_view;" + time;
            data[hashStr] = {
              ads_id: adsId,
              hash: adsHash,
              hostname,
...
function getQueryParams(url) {
  const s1 = url.search.substring(1, url.search.length).split("&");
  const r = {};
  let s2;
  let i;
...
!(function(r, t) {
  ...
  const n = "ARRAYBUFFER not supported by this environment";
  const i = "UINT8ARRAY not supported by this environment";
      ...
      case "TEXT":
        return function(r, t, n) {
          return (function(r, t, n, i, e) {
            ...
            const l = (i = i || 0) >>> 3;
            if (t === "UTF8")
              for (c = e === -1 ? 3 : 0, s = 0; s < r.length; s += 1)
                for (
                  u = [],
                    (o = r.charCodeAt(s)) < 128
                      ? u.push(o)
                      : o < 2048
      ...
      case "B64":
        return function(r, n, i) {
          return (function(r, n, i, e) {
            ...
            const E = e === -1 ? 3 : 0;
            const l = r.indexOf("=");
            if (r.search(/^[a-zA-Z0-9=+/]+$/) === -1)
              throw new Error("Invalid character in base-64 string");
            if (((r = r.replace(/=/g, "")), l !== -1 && l < r.length))
  ...
  function a(r) {
    ...
    const n = r || {};
    const i = "Output length must be a multiple of 8";
    if (
  ...
  function p(r, t, n, i) {
    const e = (65535 & r) + (65535 & t) + (65535 & n) + (65535 & i);
    return (
      ((65535 &
  ...
  function d(r, t, n, i, e) {
    const o =
      (65535 & r) + (65535 & t) + (65535 & n) + (65535 & i) + (65535 & e);
    return (
      ((65535 &
        ((r >>> 16) +
          (t >>> 16) +
  ...
  function T(r) {
    return r == "SHA-224" ? f.slice() : h.slice();
  }
  ...
  return (function(t) {
    function n(r, n, i) {
      ...
      return (
        ...
        (e.R = T(r)),
        (e.m = 512),
        (e.F = r === "SHA-224" ? 224 : 256),
        (e.g = !1),
        u.hmacKey &&
          e.B(
            (function(r, t, n, i) {
              const e = r + " must include a value and format";
              if (!t) {
    ...
    (function() {
      ...
      return (
        (r.prototype.update = function(r) {
          ...
          let n = 0;
          const i = this.m >>> 5;
          const e = this.h(r, this.S, this.Y);
          const o = e.binLen;
          const u = e.value;
          const s = o >>> 5;
          for (t = 0; t < s; t += i)
        ...
        (r.prototype.setHMACKey = function(r, t, n) {
          ...
          const i = o(t, (n || {}).encoding || "UTF8", this.u);
          this.B(i(r));
        }),
